...
<body>
    <h1>Aurich Sistema - Vendas // <a class = "red" href="painel.php" ><strong>VOLTAR</strong></a></h1>
    <h2>Cadastrar Venda</h2>

    <form action="addOrcamento.php" method="POST">
            <a>Número do cliente</a>
            <input name="nuCliente" name="text" autofocus="">
    ...
    include('conexao.php');
        ...
        while($row = mysqli_fetch_assoc($QueryGetProdutosResult)) {
            ...
            echo "<table><td>".$row["id"]."<td>".$row["nome"]."<td>".$row["CPF"]."</td></table>"."<br>";
        }
    ?>
</body>
</html>